...
namespace Xerath
{
    public class Program
    {
        ...
        private static string News = "Welcome to Pasted Copy Series";
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            if (player.ChampionName != CHAMP_NAME)
                return;
            Game.PrintChat("<font size='30'>Love's Xerath</font> <font color='#C80E96'>by Lovetaiwan</font>");
            Game.PrintChat("<font color='#C80E96'>NEWS: </font>" + Program.News);
            // Clear the console
            Utils.ClearConsole();
