...
namespace Xerath
{
    public class Config
    {
        public const string MENU_NAME = "[Lovetaiwan] " + Program.CHAMP_NAME;
        ...
        public static void Initialize()
        {
            ...
            //ProcessLink("fleeNothing", subMenu.AddLinkedBool("Nothing Here"));
            ProcessLink("fleeActive", subMenu.AddLinkedKeyBind("Flee active", 'J', KeyBindType.Press));
